<!DOCTYPE html>
<html lang="en"
      class="@if(setting_get('website.darkMode', true)) dark @endif {{ setting_get('website.currentTheme', true) }}">
<head>
    <x-head title="{{$title}}">
    </x-head>
    <x-styles>
...
<div
    ...
    <div class="h-full flex items-center">
        ...
        <a href="" class="logo -intro-x hidden md:flex xl:w-[180px] block">
            <img alt="TODAY COUPON" class="logo__image w-6" src="{{ asset('dist/images/logo.svg') }}">
            <span class="logo__text text-white text-lg ml-3"> TODAY COUPON </span>
        </a>
...
{{--<div data-url="side-menu-light-dashboard-overview-1.html"--}}
