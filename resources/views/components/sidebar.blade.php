...
<nav class="side-nav">
    <ul>
        @foreach($menu as $item)
            @canany($item->get('condition') ?: $item->last()->pluck('condition')->filter())
                <li>
                    <a class="side-menu"
                    ...
                    <ul>
                        @foreach($item->last() as $childItem)
                            @canany($childItem->get('condition') ?: $childItem->last()->pluck('condition')->filter())
                                <li class="">
